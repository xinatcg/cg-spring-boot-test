...
public class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.geek.grpc.lib.hello.HelloRequest,
      com.geek.grpc.lib.hello.HelloResponse> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "HelloService", "SayHello"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.geek.grpc.lib.hello.HelloRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.geek.grpc.lib.hello.HelloResponse.getDefaultInstance()));
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.geek.grpc.lib.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.geek.grpc.lib.hello.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.geek.grpc.lib.hello.HelloRequest,
                com.geek.grpc.lib.hello.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.geek.grpc.lib.hello.HelloResponse sayHello(com.geek.grpc.lib.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.geek.grpc.lib.hello.HelloResponse> sayHello(
        com.geek.grpc.lib.hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.geek.grpc.lib.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.geek.grpc.lib.hello.HelloResponse>) responseObserver);
          break;
        default:
